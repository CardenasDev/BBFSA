...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'API REST administrativa de Barro Blanco Farms. La persistencia se realiza mediante procedimientos almacenados SP_BBF_*.',
    ],

    'ui' => [
        'title' => 'BBF SisAdmin API',
    ],
    ...
    'security_strategy' => [
        ...
        [
            ...
            'scheme' => SecurityScheme::http('bearer', 'JWT')
                ->as('bearerAuth')
                ->setDescription('Ingrese únicamente el access token JWT, sin el prefijo Bearer.'),
        ],
    ],
];

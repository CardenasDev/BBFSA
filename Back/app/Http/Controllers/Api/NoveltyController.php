...
class NoveltyController extends ApiController
{
 ...
 /** Reporte filtrable del seguimiento de incapacidades. */ public function disabilityTrackingIndex(ListDisabilityTrackingRequest $r): JsonResponse { return $this->success($this->service->listDisabilityTracking($r->validated()),'Seguimientos consultados correctamente.'); }

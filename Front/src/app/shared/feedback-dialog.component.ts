  ...
  template: `
    <div class="feedback-backdrop" role="presentation">
      <section class="feedback-dialog" role="alertdialog" aria-modal="true"
        ...
        <button class="btn primary" type="button" (click)="closed.emit()" autofocus>Entendido</button>
      </section>
    </div>
  `,
  styles: [`
    ...
    h2{margin:0 0 .55rem;font-size:1.25rem}p{margin:0 0 1.25rem;line-height:1.5;white-space:pre-line}.btn{min-width:8.5rem}
  `],
})

  ...
  template: `
    ...
    <section class="panel">
      ...
      <form class="form-grid" (ngSubmit)="save()">
        ...
        <label>Fecha afiliación EPS<input type="date" name="fecha_afiliacion_eps" [(ngModel)]="form.fecha_afiliacion_eps" [disabled]="!canEdit() || saving()" /></label>
        ...
        <label>Fecha afiliación ARL<input type="date" name="fecha_afiliacion_arl" [(ngModel)]="form.fecha_afiliacion_arl" [disabled]="!canEdit() || saving()" /></label>
        ...
        <label>Fecha afiliación pensión<input type="date" name="fecha_afiliacion_pension" [(ngModel)]="form.fecha_afiliacion_pension" [disabled]="!canEdit() || saving()" /></label>
        ...
        <label>Fecha afiliación cesantías<input type="date" name="fecha_afiliacion_cesantias" [(ngModel)]="form.fecha_afiliacion_cesantias" [disabled]="!canEdit() || saving()" /></label>
        ...
        <label>Fecha afiliación caja<input type="date" name="fecha_afiliacion_caja" [(ngModel)]="form.fecha_afiliacion_caja" [disabled]="!canEdit() || saving()" /></label>

...
Route::middleware('auth.jwt')->group(function (): void {
    ...
    Route::prefix('contracting')->group(function (): void {
        ...
        Route::delete('employees/{employeeId}/contracts/{employeeContractId}', [ContractingController::class, 'deleteContract'])->whereNumber(['employeeId', 'employeeContractId'])->middleware('permission:CONTRATACION_ELIMINAR');
